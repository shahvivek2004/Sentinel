...
const NAV = [
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-4 h-4" stroke="currentColor" strokeWidth="1.5">
        ...
        <path d="M10 1v3M10 16v3M1 10h3M16 10h3M3.22 3.22l2.12 2.12M14.66 14.66l2.12 2.12M3.22 16.78l2.12-2.12M14.66 5.34l2.12-2.12" strokeLinecap="round" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 20 20" fill="none" className="w-4 h-4" stroke="currentColor" strokeWidth="1.5">
        <path d="M13 10a3 3 0 11-6 0 3 3 0 016 0zM7.5 4.5a3 3 0 00-3 3v1M12.5 4.5a3 3 0 013 3v1M7.5 15.5a3 3 0 01-3-3v-1M12.5 15.5a3 3 0 003-3v-1" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    <aside className="w-56 shrink-0 border-r border-white/6 bg-[#080C10] flex flex-col h-screen sticky top-0">
      ...
      <div className="px-5 h-14 flex items-center border-b border-white/6">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white text-base tracking-tight">Sentinel</span>
        </Link>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        {NAV.map((item) => {
          ...
          return (
            ...
            >
              <span className={active ? "text-cyan-400" : "text-zinc-600 group-hover:text-zinc-400 transition-colors"}>
                {item.icon}
              </span>
      ...
      <div className="px-3 py-4 border-t border-white/6 space-y-1">
        ...
        <div className="px-3 py-2 rounded-lg bg-cyan-400/6 border border-cyan-400/10 mb-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/billing" className="text-[10px] text-cyan-400 hover:text-cyan-300 transition-colors">
              Upgrade →
            </Link>
          </div>
        ...
        <button className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/4 transition-all group">
          ...
          <div className="flex-1 text-left min-w-0">
            <p className="text-xs text-zinc-300 font-medium truncate">Ada Lovelace</p>
            <p className="text-[10px] text-zinc-600 truncate">ada@company.com</p>
          </div>
          <svg viewBox="0 0 16 16" fill="none" className="w-3.5 h-3.5 text-zinc-700 group-hover:text-zinc-500 transition-colors shrink-0">
