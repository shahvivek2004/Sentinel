  ...
  return (
    <header className="h-14 border-b border-white/6 flex items-center justify-between px-6 bg-[#080C10] sticky top-0 z-10">
      <div>
        ...
        <p className="text-xs text-zinc-600">Track your infrastructure uptime</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="relative w-8 h-8 flex items-center justify-center rounded-lg border border-white/[0.07] bg-white/3 hover:bg-white/6 transition-all text-zinc-500 hover:text-zinc-300">
          <svg viewBox="0 0 16 16" fill="none" className="w-4 h-4" stroke="currentColor" strokeWidth="1.5">
            <path d="M8 1.5a4.5 4.5 0 00-4.5 4.5v2.5L2 10h12l-1.5-1.5V6A4.5 4.5 0 008 1.5zM6.5 12a1.5 1.5 0 003 0" strokeLinecap="round" />
          </svg>
        ...
        <Link
          ...
          className="flex items-center gap-1.5 bg-cyan-400 text-black font-semibold text-xs px-3 py-2 rounded-lg hover:bg-cyan-300 transition-all hover:shadow-[0_0_16px_rgba(34,211,238,0.3)]"
        >
