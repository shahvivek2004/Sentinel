  ...
  if (sent) {
    return (
      <div className="animate-fade-up text-center">
        ...
        <Link href="/signin" className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors">
          ← Back to sign in
        </Link>
      </div>
    );
      ...
      <div className="mb-8">
        <div className="w-11 h-11 bg-white/4 border border-white/8 rounded-xl flex items-center justify-center mb-5">
          <svg className="w-5 h-5 text-zinc-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5">
            <path d="M10 2a4 4 0 00-4 4v1H5a2 2 0 00-2 2v7a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2h-1V6a4 4 0 00-4-4zm0 2a2 2 0 012 2v1H8V6a2 2 0 012-2zm0 8a1 1 0 110 2 1 1 0 010-2z" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
