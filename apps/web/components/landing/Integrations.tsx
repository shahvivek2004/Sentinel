    ...
    <section className="py-24 max-w-6xl mx-auto px-6">
      <div className="text-center mb-14">
        ...
        <p className="text-zinc-500 mt-4 max-w-xl mx-auto">
          Sentinel integrates with every tool in your on-call workflow. One
          click to connect — no custom code required.
        </p>
      </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="border-l-4 border-red-500 pl-3">
                ...
                <p className="text-xs text-zinc-400">
                  <span className="font-mono text-zinc-300">api.myapp.com</span>{" "}
                  is unreachable from 3 regions.
                </p>
        ...
        <div className="bg-white/3 rounded-lg border border-white/5 p-4">
          <div className="border-b border-white/5 pb-3 mb-3">
            ...
            <p className="text-xs text-zinc-600">
              Subject:{" "}
              <span className="text-zinc-400">🔴 api.myapp.com is DOWN</span>
            </p>
          </div>
          <p className="text-xs text-zinc-400 leading-relaxed">
            Your monitor{" "}
            <span className="font-mono text-zinc-300">api.myapp.com</span> is
            reporting a failure from{" "}
            <span className="text-white">Frankfurt</span>,{" "}
            <span className="text-white">Singapore</span>, and{" "}
            <span className="text-white">Virginia</span>.
          </p>
          <div className="mt-3 flex gap-2">
            <span className="text-[10px] bg-red-500/10 text-red-400 px-2 py-1 rounded">
              View incident
            </span>
            <span className="text-[10px] bg-white/5 text-zinc-500 px-2 py-1 rounded">
              Acknowledge
            </span>
          </div>
        </div>
